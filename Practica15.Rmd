...
evolution %>% ggplot(aes(close_time, close)) + geom_line() +xlab("Time in month") + ylab("Price $") + ggtitle("BTC Price Evolution")
...
klines %>% ggplot(aes(format(close_time, format='%H%M'), close, colour=day, group=day )) + geom_line() +xlab("Time in quarter") + ylab("Price $") + ggtitle("BTC Price Evolution")
```
...
```{r}
evolution %>% ggplot(aes(close_time, close))+ geom_line(aes(y = volume)) +xlab("Time in month") + ylab("Volume") + ggtitle("BTC Volume Evolution")
```


## Volumen del BTC en los últimos días
```{r}
klines %>% ggplot(aes(close_time, volume))+ geom_line() +xlab("Time in quarter") + ylab("Volume") + ggtitle("BTC Volume Evolution")
...
```{r}
evolution %>% ggplot(aes(close_time, close)) + geom_line(aes(y = close)) + geom_col(aes(y = volume/100), alpha=0.2) + scale_y_continuous("Price ($)", sec.axis = sec_axis(~ . * 100, name = "Volumen")) + ggtitle("BTC Volume vs Price")
```
...
```{r}
klines %>% ggplot(aes(close_time, close)) + geom_line() +xlab("Time in quarter") + ylab("Price $") + ggtitle("BTC Price Evolution")
klines %>% ggplot(aes(close_time, volume)) + geom_line() +xlab("Time in quarter") + ylab("Volume") + ggtitle("BTC Volume Evolution")
```
